...
static const char *fonts[]          = { "DejaVu Sans Mono:size=10:antialias=true:autohint=true" };
static const char dmenufont[]       = "DejaVu Sans Mono:size=10:antialias=true:autohint=true";
...
/* layout(s) */
static const float mfact     = 0.4973; /* factor of master area size [0.05..0.95] */
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_f,    togglefullscreen, {.v = &layouts[2]} },
